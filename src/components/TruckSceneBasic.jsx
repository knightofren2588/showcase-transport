  ...
  return (
    <figure className={`st-baseline ${className}`}>
      <style>{`
        ...
        /* NEW: Cloud Drift Animations - Slow movement across sky */
      ...
      >
        ...
        {/* NEW: Mountain silhouette in far background */}
        <g opacity="0.3">
          <polygon points="0,130 100,80 200,110 300,70 400,95 500,60 600,100 700,75 800,120 800,150 0,150" fill="#2a3a4a" />
        </g>
        ...
        {/* NEW: Clouds drifting across sky */}
        <g className="st-cloud-1" opacity="0.6">
          <ellipse cx="150" cy="30" rx="40" ry="15" fill="#FFFFFF" />
          <ellipse cx="130" cy="35" rx="30" ry="12" fill="#FFFFFF" />
          <ellipse cx="170" cy="35" rx="35" ry="13" fill="#FFFFFF" />
        </g>
        
        <g className="st-cloud-2" opacity="0.5">
          <ellipse cx="400" cy="50" rx="35" ry="12" fill="#FFFFFF" />
          <ellipse cx="380" cy="55" rx="25" ry="10" fill="#FFFFFF" />
          <ellipse cx="420" cy="55" rx="30" ry="11" fill="#FFFFFF" />
        </g>
        
        <g className="st-cloud-3" opacity="0.55">
          <ellipse cx="600" cy="70" rx="45" ry="14" fill="#FFFFFF" />
          <ellipse cx="575" cy="75" rx="32" ry="11" fill="#FFFFFF" />
          <ellipse cx="625" cy="75" rx="38" ry="12" fill="#FFFFFF" />
        </g>
        ...
        {/* NEW: Trees near facility - add depth and life */}
        {/* Tree 1 - Left side near building */}
        <g transform="translate(5, 110)">
          <rect x="0" y="20" width="6" height="30" fill="#5a4a3a" />
          <g className="st-tree-leaves" style={{ transformOrigin: '3px 15px' }}>
            <ellipse cx="3" cy="15" rx="15" ry="18" fill="#2d5016" opacity="0.8" />
            <ellipse cx="3" cy="10" rx="12" ry="15" fill="#3a6b1f" opacity="0.9" />
            <ellipse cx="3" cy="5" rx="10" ry="12" fill="#4a7f2a" />
          </g>
        </g>
        
        {/* Tree 2 - Right side in distance */}
        <g transform="translate(680, 120)" opacity="0.7">
          <rect x="0" y="15" width="5" height="25" fill="#5a4a3a" />
          <g className="st-tree-leaves" style={{ transformOrigin: '2.5px 12px' }}>
            <ellipse cx="2.5" cy="12" rx="12" ry="15" fill="#2d5016" opacity="0.8" />
            <ellipse cx="2.5" cy="8" rx="10" ry="12" fill="#3a6b1f" opacity="0.9" />
            <ellipse cx="2.5" cy="4" rx="8" ry="10" fill="#4a7f2a" />
          </g>
        </g>
